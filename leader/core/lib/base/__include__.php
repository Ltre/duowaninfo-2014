...
require_once APPROOT.PUBLIC_DIR_NAME.'/core/lib/base/core__.php';	//框架核心支持
require_once APPROOT.PUBLIC_DIR_NAME.'/core/lib/base/env__.php';	//环境配置
require_once APPROOT.PUBLIC_DIR_NAME.'/core/lib/base/url__.php';	//URL解析支持
require_once APPROOT.PUBLIC_DIR_NAME.'/core/lib/base/filter__.php';	//过滤器支持，为“指令————Action调度”中间提供一道关卡
require_once APPROOT.PUBLIC_DIR_NAME.'/core/lib/base/action__.php';	//调度器支持
...
require_once APPROOT.PUBLIC_DIR_NAME.'/core/lib/base/init__.php';	//以上所有文件包含完毕后，最后包含初始化文件，以便执行处理业务前的准备。
